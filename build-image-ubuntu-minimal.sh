...
IMG_FILE="deploy/rk3568-mixtile-edge2-ubuntu-minimal.img"
ROOTFS_FILE="rootfs/rootfs-ubuntu-minimal.tar.gz"
ROOTFS_BUILD_SCRIPT="mk-rootfs-ubuntu.sh"
PARTITION_SCRIPT="scripts/mixtile-edge2-disk-parts-minimal.sfdisk"
...
if [ ! -f "kernel/deploy/rk3568-mixtile-edge2.dtb" ]; then
...
cp -v "kernel/deploy/rk3568-mixtile-edge2.dtb" "${TMP_MOUNT_DIR}/bootfs/"
